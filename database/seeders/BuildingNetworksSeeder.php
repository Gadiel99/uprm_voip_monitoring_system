...
class BuildingNetworksSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $buildings = [
            ...
            ['name' => 'Banda y Orquesta', 'map_x' => 10.3, 'map_y' => 26.9, 'networks' => ['10.100.147.32']],
            ['name' => 'Taller de Arte', 'map_x' => 1.9, 'map_y' => 18.4, 'networks' => ['10.100.147.64']],
            ...
            ['name' => 'Prescolar', 'map_x' => 9.9, 'map_y' => 20.1, 'networks' => ['10.100.147.144']],
            ['name' => 'Ing.Agricola', 'map_x' => 50.9, 'map_y' => 38.1, 'networks' => ['10.100.148.0']],
            ['name' => 'CITAI', 'map_x' => 17.3, 'map_y' => 10.5, 'networks' => ['10.100.148.192']],
            ...
            ['name' => 'Instituto de Recursos de Aguas', 'map_x' => 14.2, 'map_y' => 16.5, 'networks' => ['10.100.159.0']],
            ['name' => 'Siempre Vivas', 'map_x' => 8.5, 'map_y' => 37.4, 'networks' => ['10.100.159.96']],
            ['name' => 'CISA', 'map_x' => 7.8, 'map_y' => 13.1, 'networks' => ['10.100.159.128']],
            ['name' => 'Gimnasio', 'map_x' => 54.1, 'map_y' => 66.7, 'networks' => ['10.100.159.160']],
            ['name' => 'Vagones', 'map_x' => 53, 'map_y' => 48, 'networks' => ['10.100.159.192']],
            ['name' => 'CID', 'map_x' => 6.3, 'map_y' => 23.9, 'networks' => ['10.100.160.0']],
