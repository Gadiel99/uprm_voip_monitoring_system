...
class BuildingNetworksSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $buildings = [
            ...
            ['name' => 'Impresos', 'map_x' => 50, 'map_y' => 50, 'networks' => ['10.100.117.64']],
            ...
            ['name' => 'Darlington', 'map_x' => 70, 'map_y' => 55, 'networks' => ['10.100.146.0']],
            ['name' => 'Central Telefonica', 'map_x' => 68, 'map_y' => 60, 'networks' => ['10.100.147.0']],
            ['name' => 'Banda y Orquesta', 'map_x' => 65, 'map_y' => 58, 'networks' => ['10.100.147.32']],
            ['name' => 'Taller de Arte', 'map_x' => 63, 'map_y' => 56, 'networks' => ['10.100.147.64']],
            ...
            ['name' => 'Prescolar', 'map_x' => 45, 'map_y' => 70, 'networks' => ['10.100.147.144']],
            ['name' => 'Ing.Agricola', 'map_x' => 50.9, 'map_y' => 38.1, 'networks' => ['10.100.148.0']],
            ['name' => 'CITAI', 'map_x' => 55, 'map_y' => 45, 'networks' => ['10.100.148.192']],
            ['name' => 'Terrats', 'map_x' => 81, 'map_y' => 48, 'networks' => ['10.100.149.0']],
            ['name' => 'Edificios y Terrenos', 'map_x' => 40, 'map_y' => 50, 'networks' => ['10.100.150.0']],
            ...
            ['name' => 'Instituto de Recursos de Aguas', 'map_x' => 25, 'map_y' => 40, 'networks' => ['10.100.159.0']],
            ['name' => 'Siempre Vivas', 'map_x' => 30, 'map_y' => 45, 'networks' => ['10.100.159.96']],
            ['name' => 'CISA', 'map_x' => 35, 'map_y' => 48, 'networks' => ['10.100.159.128']],
            ['name' => 'Gimnasio', 'map_x' => 54.1, 'map_y' => 66.7, 'networks' => ['10.100.159.160']],
            ['name' => 'Vagones', 'map_x' => 53, 'map_y' => 48, 'networks' => ['10.100.159.192']],
            ['name' => 'CID', 'map_x' => 60, 'map_y' => 65, 'networks' => ['10.100.160.0']],
