                            ...
                            <li>
                                <form action="{{ url('/exit-user-preview') }}" method="POST">
                                    ...
                                    <button type="submit" class="dropdown-item text-danger">
                                        <i class="bi bi-eye-slash me-2"></i>Exit User Preview
                                    </button>
                                </form>
                            </li>
                        @else
                            <li>
                                <form action="{{ url('/enter-user-preview') }}" method="POST">
                                    ...
                                    <button type="submit" class="dropdown-item">
                                        <i class="bi bi-eye me-2 text-secondary"></i>User Preview
                                    </button>
                                </form>
                            </li>
                        @endif
            ...
            <div class="modal-content border-0 shadow-lg rounded-4">
                ...
                <div class="modal-body">
                    ...
                    <ul class="nav nav-pills mb-4 justify-content-center" id="accountTab" role="tablist">
                        <li class="nav-item"><button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profileTab" type="button">Profile Picture</button></li>
                        <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#usernameTab" type="button">Username</button></li>
                        <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#emailTab" type="button">Email</button></li>
                        <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#passwordTab" type="button">Password</button></li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active text-center" id="profileTab" role="tabpanel">
                            <div class="mb-3">
                                <img src="{{ asset('images/default-avatar.png') }}" alt="User Avatar" class="rounded-circle border mb-3" width="120" height="120">
